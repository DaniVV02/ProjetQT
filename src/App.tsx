  ...
  french: {
    ...
    tiger: {
      ...
      pages: [
        ...
        { text: "Un jour, les autres animaux de la jungle décidèrent d'organiser une grande fête pour célébrer l'arrivée du printemps. Téo était invité, mais il se sentait nerveux.", emotion: "excited" },
  ...
  english: {
    ...
    cat: {
      ...
      pages: [
        ...
        { text: "Grizou, though excited, agreed to follow his friend. They walked quietly, and at every sound, Grizou tensed up, but Max reminded him everything was fine.", emotion: "neutral" },
        ...
        { text: "Grizou, still excited, felt a bit more secure. He followed Max further, his paws trembling less.", emotion: "neutral" },
    ...
    rabbit: {
      ...
      pages: [
        ...
        { text: "But the further he went, the more excited he felt. The place became darker, and the trees seemed to get closer.", emotion: "sad" },
    ...
    tiger: {
      ...
      pages: [
        ...
        { text: "One day, the other animals of the jungle decided to throw a big party to celebrate the arrival of spring. Téo was invited, but he felt excited.", emotion: "excited" },
